...
// Fetch students for ICT STALLMAN
$students = [];
$result = $conn->query("SELECT * FROM registration_student_guidanceinformation WHERE strand = 'ICT STALLMAN'");
...
<head>
  ...
  <title>Guidance Portal Information Stallman</title>
  <!-- Google Fonts (Inter) -->
  ...
  <div class="container">
    <header class="topbar">
      <div class="topbarInner">
        <div class="pageHead">
          <h1 class="pageTitle">Guidance Portal Information Stallman</h1>
          <p class="pageDesc">View and manage students enrolled in ICT STALLMAN.</p>
        </div>
    ...
    <section class="panel">
      <div class="panelHead">
        <h2>Information</h2>
        <span style="color: var(--text-muted); font-size: 0.8rem;">ICT STALLMAN</span>
      </div>
      <div class="panelBody">
        <div class="toolbar">
          <div class="search">
    ...
    (function() {
      ...
      document.querySelectorAll('.save-btn').forEach(btn => {
        btn.addEventListener('click', function() {
          ...
          fetch('guidance_information_stallman.php', {
              method: 'POST',
              body: formData
            })
            .then(res => res.json())
