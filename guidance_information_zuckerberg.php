...
// Fetch students for ICT ZUCKERBERG
$students = [];
$result = $conn->query("SELECT * FROM registration_student_guidanceinformation WHERE strand = 'ICT ZUCKERBERG'");
...
<head>
  ...
  <title>Guidance Portal Information Zuckerberg</title>
  <!-- Google Fonts (Inter) -->
  ...
  <div class="container">
    <header class="topbar">
      <div class="topbarInner">
        <div class="pageHead">
          <h1 class="pageTitle">Guidance Portal Information Zuckerberg</h1>
          <p class="pageDesc">View and manage students enrolled in ICT ZUCKERBERG.</p>
        </div>
    ...
    <section class="panel">
      <div class="panelHead">
        <h2>Information</h2>
        <span style="color: var(--text-muted); font-size: 0.8rem;">ICT ZUCKERBERG</span>
      </div>
      <div class="panelBody">
        <div class="toolbar">
          <div class="search">
    ...
    (function() {
      ...
      document.querySelectorAll('.save-btn').forEach(btn => {
        btn.addEventListener('click', function() {
          ...
          fetch('guidance_information_zuckerberg.php', {
              method: 'POST',
              body: formData
            })
            .then(res => res.json())
