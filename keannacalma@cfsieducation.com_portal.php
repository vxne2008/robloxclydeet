...
} elseif (strtoupper($student_strand) === 'ABM MASLOW' || stripos($student_strand, 'MASLOW') !== false) {
    $subject_table = 'subject_schedule_maslow';
    $grades_table = 'grades_maslow';
    $attendance_table = 'attendance_maslow';
} elseif (strtoupper($student_strand) === 'HUMSS VOLTAIRE' || stripos($student_strand, 'VOLTAIRE') !== false) {
            ...
            <main class="content">
                ...
                <section class="card" id="student-info" data-title="Student Info"
                    ...
                    <div class="grid-2">
                        ...
                        <div class="kpi">
                            ...
                            <div class="kpi-subaction"><a href="#" class="att-view" data-status="Present">View
                                    Details</a></div>
                        </div>
                        <div class="kpi">
                            <div class="kpi-label">Absents</div>
                            <div class="kpi-value"><?php echo h($absent); ?></div>
                            <div class="kpi-subaction"><a href="#" class="att-view" data-status="Absent">View
                                    Details</a></div>
                        </div>
                        ...
                        <div class="kpi">
                            ...
                            <div style="margin-top: 8px; font-size: 13px; font-weight: 650;"
                ...
                <section class="card hidden" id="subjects" data-title="Subject Enrolled"
                    ...
                    <div style="margin-bottom: 24px;">
                        <h3 style="font-size: 18px; font-weight: 950; margin-bottom: 12px; color: var(--blue);">1st
                            Semester</h3>
                    ...
                    <div>
                        <h3 style="font-size: 18px; font-weight: 950; margin-bottom: 12px; color: var(--blue);">2nd
                            Semester</h3>
                ...
                <section class="card hidden" id="personal-info" data-title="Personal Information"
                    ...
                    <table aria-label="Personal Information">
                        ...
                        <tbody>
                            <tr>
                                <td>Last name</td>
                                <td><?php echo trim((string) $student['last_name']) !== '' ? h($student['last_name']) : '—'; ?>
                                </td>
                            </tr>
                            <tr>
                                <td>First Name</td>
                                <td><?php echo trim((string) $student['first_name']) !== '' ? h($student['first_name']) : '—'; ?>
                                </td>
                            </tr>
                            <tr>
                                <td>Middle Name</td>
                                <td><?php echo trim((string) $student['middle_name']) !== '' ? h($student['middle_name']) : '—'; ?>
                                </td>
                            </tr>
                            <tr>
                                <td>LRN Number</td>
                                <td><?php echo trim((string) $student['lrn']) !== '' ? h($student['lrn']) : '—'; ?></td>
                            </tr>
                            <tr>
                                <td>Email Address</td>
                                <td><?php echo trim((string) $student['email']) !== '' ? h($student['email']) : '—'; ?>
                                </td>
                            </tr>
                            <tr>
                                <td>Contact Number</td>
                                <td><?php echo trim((string) $student['contact']) !== '' ? h($student['contact']) : '—'; ?>
                                </td>
                            </tr>
                            <tr>
                                <td>Home Address</td>
                                <td><?php echo trim((string) $student['address']) !== '' ? h($student['address']) : '—'; ?>
                                </td>
                            </tr>
                            <tr>
                                <td>Birth Date</td>
                                <td><?php echo trim((string) $student['birthdate']) !== '' ? h($student['birthdate']) : '—'; ?>
                                </td>
                            </tr>
                            <tr>
                                <td>Guardian Name</td>
                                <td><?php echo trim((string) $student['guardian_name']) !== '' ? h($student['guardian_name']) : '—'; ?>
                                </td>
                            </tr>
                            <tr>
                                <td>Guardian Contact Number</td>
                                <td><?php echo trim((string) $student['guardian_contact']) !== '' ? h($student['guardian_contact']) : '—'; ?>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <form class="editWrap hidden" id="personalInfoEditForm">
                        ...
                        <div class="form-grid">
                            <div class="field">
                                ...
                                <input id="pi_lastname" name="lastname" type="text"
                                    value="<?php echo h($student['last_name']); ?>" autocomplete="off" />
                            </div>
                            <div class="field">
                                <label for="pi_firstname">First Name</label>
                                <input id="pi_firstname" name="firstname" type="text"
                                    value="<?php echo h($student['first_name']); ?>" autocomplete="off" />
                            </div>

                            <div class="field">
                                <label for="pi_middlename">Middle Name</label>
                                <input id="pi_middlename" name="middlename" type="text"
                                    value="<?php echo h($student['middle_name']); ?>" autocomplete="off" />
                            </div>
                            <div class="field">
                                <label for="pi_lrn">LRN Number</label>
                                <input id="pi_lrn" name="lrn" type="text" value="<?php echo h($student['lrn']); ?>"
                                    inputmode="numeric" pattern="1595[0-9]{8}" minlength="12" maxlength="12"
                                    autocomplete="off" />
                            </div>

                            <div class="field">
                                <label for="pi_email">Email Address</label>
                                <input id="pi_email" name="email" type="email"
                                    value="<?php echo h($student['email']); ?>" autocomplete="off" />
                            </div>
                            <div class="field">
                                <label for="pi_contact">Contact Number</label>
                                <input id="pi_contact" name="contact" type="tel"
                                    value="<?php echo h($student['contact']); ?>" inputmode="numeric" pattern="[0-9]*"
                                    autocomplete="off" />
                            </div>

                            <div class="field" style="grid-column: 1 / -1;">
                                <label for="pi_address">Home Address</label>
                                <textarea id="pi_address" name="address"
                                    autocomplete="off"><?php echo h($student['address']); ?></textarea>
                            </div>

                            <div class="field">
                                <label for="pi_birthdate">Birth Date</label>
                                <input id="pi_birthdate" name="birthdate" type="date"
                                    value="<?php echo h($student['birthdate']); ?>" />
                            </div>
                            <div class="field">
                                <label for="pi_guardian">Guardian Name</label>
                                <input id="pi_guardian" name="guardian" type="text"
                                    value="<?php echo h($student['guardian_name']); ?>" autocomplete="off" />
                            </div>

                            <div class="field">
                                <label for="pi_guardian_contact">Guardian Contact Number</label>
                                <input id="pi_guardian_contact" name="guardian_contact" type="tel"
                                    value="<?php echo h($student['guardian_contact']); ?>" inputmode="numeric"
        ...
        <script>
            (function () {
                ...
                function openAttendanceModal() {
                    ...
                    // Load both semesters
                    fetchAttendanceDetails('1st', 'attendanceTbody1st');
                    fetchAttendanceDetails('2nd', 'attendanceTbody2nd');
                }
                ...
                function fetchAttendanceDetails(semester, tbodyId) {
                    ...
                    fetch(url)
                        ...
                        .catch(function () {
                            var tbody = document.getElementById(tbodyId);
                            if (tbody) tbody.innerHTML = '<tr><td colspan="3">Failed to load.</td></tr>';
                        });
                }
